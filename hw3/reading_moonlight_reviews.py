...
# python script to automate pasting strongs from json file into Lyrebird and downloading them onto my computer
# february 2018
...
def main():
    ...
    print "parse info from file comments_moonlight.json"
    ...
    for i in range(len(data)):
        ...
        comments.append(data[i]["commentText"])

    # confirm that the length matches with the length of the json file
    print len(comments)

    print "number of comments to record: " + str(len(comments))
